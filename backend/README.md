...
## Project Structure
    ...
    ├── testapiautoteammemb_55733  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_55733`
...
2. Clone this repo and `cd testapiautoteammemb_55733`
